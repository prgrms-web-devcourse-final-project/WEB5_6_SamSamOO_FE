  ...
  if (!content || content.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 px-8">
        <h1 className="text-2xl font-bold mb-3 text-center">판례 검색 결과가 없습니다</h1>
        <p className="text-gray-500 text-center">입력하신 조건에 맞는 판례가 존재하지 않습니다</p>
      </div>
    );
  }
