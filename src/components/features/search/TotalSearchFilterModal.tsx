...
function TotalSearchFilterModal({
  isOpen,
  onClose = () => {},
      ...
      >
        <div className="flex flex-col gap-6 text-lg justify-center ">
          ...
          <div className="flex items-center">
            <h2 className="text-2xl w-2/8 sm:w-1/8 font-bold text-brand-primary dark:text-primary-white">
              법령
            </h2>
            <div className="bg-filter-outline1 h-[1] w-6/8 sm:w-full"></div>
          </div>
          ...
          >
            ...
            {openCalendar === 'sentencing' && (
              <div className="absolute bottom-13 sm:right-0 z-10 w-full sm:w-[82%]">
