...
function MetadataGrid({ metadata }: Props) {
  return (
    <table className="border grid border-filter-outline2 dark:bg-primary-gray3 dark:border-border-gray1 font-medium rounded-2xl divide-y dark:divide-border-gray1 border-collapse">
