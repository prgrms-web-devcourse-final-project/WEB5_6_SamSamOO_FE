...
import AnimateRanks from './AnimateRanks';
import StaticRanks from './StaticRanks';
...
function KeywordRankClient({ rankList, className }: Props) {
...
export default KeywordRankClient;
